...
POT 1 = PHASOR 1 FREQUENCY
POT 2 = PHASOR 2 FREQUENCY
POT 3 = PHASOR 3 FREQUENCY
POT 4 = PHASOR 4 FREQUENCY
POT 5 = PHASOR 5 FREQUENCY
...
const int MaxOsc4Freq = 8800;
float Osc5Freq;
const int MinOsc5Freq = 0;
const int MaxOsc5Freq = 8800;
...
void updateControl(){
  ...
  */
  ...
  // Set Oscillators
  aPhasor1.setFreq(Osc1Freq);
  aPhasor2.setFreq(Osc2Freq);
  aPhasor3.setFreq(Osc3Freq);
  aPhasor4.setFreq(Osc4Freq);
  aPhasor5.setFreq(Osc5Freq);
}
